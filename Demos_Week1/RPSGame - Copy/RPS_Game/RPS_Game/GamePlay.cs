...
namespace RPS_Game
{
    public class GamePlay
    {
        ...
        public void RunGame()
        {
            ...
            //var pMark = db.Players.Where(s => s.Name == "Mark").FirstOrDefault();
            //var pMark1 = db.Players.Where(s => s.Name == "Jerry").FirstOrDefault();
            //Console.WriteLine($"The player searched was... ...{pMark.Name}.");
            //Console.WriteLine($"The player searched was... ...{pMark1.Name}.");

            var players = db.Players;

            foreach (var p in players)
            {
                Console.WriteLine($"Name = {p.Name}, Losses = {p.Losses}, Wins = {p.Wins}, ID = {p.PlayerId}");
            }
